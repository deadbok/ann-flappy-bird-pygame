...
"""
Flappy Bird, implemented using Pygame, and played by an ANN.

Original game: https://github.com/TimoWilken/flappy-bird-pygame
Original genetic ann idea: https://www.reddit.com/r/learnprogramming/comments/3a3rmy/python_trying_to_create_a_neural_net_with_a/
"""
...
def main():
    ...
    while not the_end:
        ...
        while not done:
            ...
            score_surface = score_font.render(str(score), True, (255, 255,
                                                                 255))
            score_x = WIN_WIDTH / 2 - score_surface.get_width() / 2
            display_surface.blit(score_surface, (score_x,
            ...
            pygame.display.set_caption('ANN Flappy Bird- Generation ' +
                                       str(brain.generation) +
                                       ' - player ' + str(player_nr) +
                                       ' - round ' + str(rounds) +
                                       ' - fitness ' +
        ...
        if rounds == 5:
            if brain.genomes[player_nr].fitness > brain.best_fit:
                print("Best fit ever, saving to file.", flush=True)
